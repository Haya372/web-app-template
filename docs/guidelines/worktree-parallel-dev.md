...
| Go Connect-RPC | 8081 | 8081 | 8181 |
| React フロントエンド | 3000 | 3000 | 3100 |
| Next.js フロントエンド | 3001 | 3001 | 3101 |
...
#   [offset=0]   APP_PORT=8080 APP_GRPC_PORT=8081 VITE_PORT=3000 NEXT_PORT=3001 DB_PORT=55432  /path/to/main
#   [offset=100] APP_PORT=8180 APP_GRPC_PORT=8181 VITE_PORT=3100 NEXT_PORT=3101 DB_PORT=55532  /path/to/feature-branch

# この worktree のポート確認
cat .env.local | grep -E '^(WORKTREE_OFFSET|APP_PORT|APP_GRPC_PORT|VITE_PORT|NEXT_PORT|DB_PORT)='
```
...
E2E_BASE_URL=http://localhost:3100       # React フロントエンド
E2E_API_BASE_URL=http://localhost:8180   # Go バックエンド REST
# E2E_NEXT_BASE_URL=http://localhost:3101  # Next.js フロントエンド（将来対応）
```
