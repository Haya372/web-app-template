...
function TestConsumer(): React.ReactElement {
  ...
  return React.createElement(
    ...
    React.createElement("span", { "data-testid": "is-authenticated" }, String(isAuthenticated)),
    React.createElement(
      "button",
      {
...
function getSpanText(testId: string): string | null {
  return container?.querySelector<HTMLElement>(`[data-testid="${testId}"]`)?.textContent ?? null;
}
