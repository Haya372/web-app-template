...
type SelectContentProps = Omit<ComponentProps<typeof SelectPrimitive.Content>, "className">;

function SelectContent({ children, position = "popper", ...props }: SelectContentProps) {
  return (
...
type SelectLabelProps = Omit<ComponentProps<typeof SelectPrimitive.Label>, "className">;

function SelectLabel({ ...props }: SelectLabelProps) {
  return <SelectPrimitive.Label className="px-2 py-1.5 text-xs font-semibold" {...props} />;
}
...
type SelectSeparatorProps = Omit<ComponentProps<typeof SelectPrimitive.Separator>, "className">;

function SelectSeparator({ ...props }: SelectSeparatorProps) {
  return <SelectPrimitive.Separator className="-mx-1 my-1 h-px bg-muted" {...props} />;
}
