...
type DialogOverlayProps = Omit<ComponentProps<typeof DialogPrimitive.Overlay>, "className">;
...
type DialogContentProps = Omit<ComponentProps<typeof DialogPrimitive.Content>, "className">;
...
type DialogDescriptionProps = Omit<ComponentProps<typeof DialogPrimitive.Description>, "className">;
